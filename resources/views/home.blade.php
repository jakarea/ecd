...
@section('content')
    ...
    <div class="modal" id="heroModal">
        <div class="modal-content relative h-[calc(100vh-50px)]">
            ...
            <div class="step-1 h-full overflow-y-auto">
                ...
                <div class="flex items-center justify-center my-[40px] gap-3">
                    <div class="flex items-center border border-[#D1D7DF] rounded-[60px] p-1.5">
                        <button
                            class="pricing-opt active bg-[var(--color-brand)] text-[#8D8D8D] text-base font-bold rounded-[60px] py-2.5 text-center uppercase inline-block cursor-pointer px-6">Single</button>
                        <button
