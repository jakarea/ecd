...
@section('content')
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5 mb-6 sm:mb-8">
        ...
        <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm stagger-item">
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6 animate-fade-in-up">
    ...
    {{-- System Information --}}
    <div class="bg-gray-50 rounded-lg shadow-sm p-4 sm:p-6 mt-4 sm:mt-6 animate-fade-in-up">
        <div class="flex justify-between items-center">
            ...
            <div class="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-green-500 rounded-full status-pulse"></div>
        </div>
    </div>
@endsection
