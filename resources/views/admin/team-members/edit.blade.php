...
@section('content')
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600">Update the team member details</p>
        </div>

        {{-- Form --}}
        <div class="bg-white rounded-lg shadow-md p-6 max-w-2xl animate-fade-in-up">
            <form action="{{ route('admin.team-members.update', ['locale' => request()->route('locale') ?? request()->segment(1), 'team_member' => $teamMember]) }}" method="POST" enctype="multipart/form-data">
