        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div class="flex flex-wrap gap-2">
                <form action="{{ route('admin.seo.recalculate') }}" method="POST" class="inline">
                    @csrf
                    <button type="submit"
                        class="inline-flex items-center justify-center px-4 py-2.5 bg-gray-600 text-white text-sm rounded-md font-medium transition-all duration-200 hover:opacity-90">
