    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6">
            <div class="flex items-center mb-4">
                <a href="{{ route('admin.faqs.index', ['locale' => request()->route('locale') ?? request()->segment(1)]) }}" class="text-[var(--color-brand)] hover:opacity-70 mr-4">
        ...
        <div class="bg-white rounded-lg shadow p-6 animate-fade-in-up">
            <form action="{{ route('admin.faqs.update', ['locale' => request()->route('locale') ?? request()->segment(1), 'faq' => $faq->id]) }}" method="POST">
                @csrf
                @method('PUT')
