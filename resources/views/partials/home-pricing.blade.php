    ...
    <div class="container">
        ...
        <div class="flex items-center gap-6">
            <div class="flex items-center border border-[#5E5E5E] rounded-[60px] p-1.5">
                <button
                    class="pricing-opt active text-[#8D8D8D] text-base font-bold rounded-[60px] p-2.5 text-center uppercase inline-block cursor-pointer min-w-[164px] active">Single</button>
                <button
                    class="pricing-opt text-[#8D8D8D] text-base font-bold rounded-[60px] p-2.5 text-center uppercase inline-block cursor-pointer min-w-[164px]">Monthly</button>
            </div>
            <div class="flex items-start">
                ...
                <div class="text-[18px] text-[var(--color-brand)] tracking-[0.8px] font-cursive">Save <span
                        class="text-[22px] text-white">25%</span> on <br /> Monthly
                    Subscriptions</span>
                </div>
            </div>
        </div>
                    ...
                    <div class="pricing-card flex flex-col justify-between p-[30px] rounded-[20px] text-white"
                        ...
                        <div class="pricing-card-header flex flex-col gap-4 pb-6 border-b"
                            ...
                            <div class="flex items-baseline gap-1">
                                ...
                                /<span class="text-[24px] font-medium leading-[1.4]">{!! $plan['frequency'] !!}
