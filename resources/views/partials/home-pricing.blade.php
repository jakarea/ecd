    ...
    <div class="container">
        ...
        <div class="flex items-center gap-6">
            ...
            <div class="flex items-start">
                ...
                <div class="text-[18px] text-[var(--color-brand)] tracking-[0.8px] font-cursive">Save <span
                        class="text-[22px] text-white">20%</span> on <br /> Monthly
                    Subscriptions</span>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                @foreach ($plans as $plan)
                    <div class="pricing-card flex flex-col justify-between p-[30px] rounded-[20px] text-white"
                        ...
                        {{-- Header --}}
                        <div class="pricing-card-header flex flex-col gap-4 pb-4 border-b"
...
<div class="modal" id="pricingModal">
    <div class="modal-content relative h-[calc(100vh-50px)]">
        <form>
            ...
            <div class="flex flex-col h-full overflow-y-auto">
                <div class="flex items-center gap-4 px-5 py-5 border border-[#C8CEDD] rounded-[16px]">
                    ...
                    <div class="space-y-2">
                        <h4 class="text-[24px] font-bold text-[var(--color-heading)] leading-[1.4]">Book your service
                        </h4>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 h-[calc(100%-180px)]">
                    <div class="">
                    ...
                    <div class="">
                        <label class="block text-base font-medium text-[var(--color-text)] mb-2">Package Choice</label>
