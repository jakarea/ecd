            ...
            'packages' => [
                'single' => [
                    ...
                    'features' => [
                        ...
                        'interior' => [
                            __('Matten stofzuigen'),
                            __('Deurlijsten reinigen'),
                            __('Dashboard afnemen'),
                        ],
                    ],
                ],
                ...
                'monthly' => [
                    'name' => __('Abonnement'),
                    'price' => '€ 79,95',
                    'frequency' => __('1 WASBEURT PER MAAND'),
                    'features' => [
                        'extra' => null,
                        'exterior' => [
                            __('Velgen reinigen'),
        ...
        [
            ...
            'packages' => [
                ...
                'single' => [
                    ...
                    'frequency' => null,
                    'features' => [
                        'extra' => __('( alles van het basic pakket + )'),
                        'exterior' => [
                            __('Lak sealing'),
                            __('Banden dressing'),
                        ],
                ...
                'monthly' => [
                    'name' => __('Abonnement'),
                    'price' => '€ 149,95',
                    'frequency' => __('2 WASBEURT PER MAAND'),
                    'features' => [
                        'extra' => null,
                        'exterior' => [
                            __('Velgen reinigen'),
        ...
        [
            ...
            'packages' => [
                ...
                'single' => [
                    ...
                    'features' => [
                        'extra' => __('( alles van het premium pakket + )'),
                        'exterior' => [
                            __('Ceramic coating'),
                            __('Bodem reinigen'),
                            __('Motorruimte reinigen'),
                        ],
                        'interior' => [
                            __('Leren of stoffen bekleding reinigen'),
                            __('Interieur stomen'),
                        ],
                    ],
                ],
                ...
                'monthly' => [
                    'name' => __('Abonnement'),
                    'price' => '€ 289,95',
                    'frequency' => __('4 WASBEURT PER MAAND'),
                    'features' => [
                        'extra' => null,
                        'exterior' => [
                            __('Velgen reinigen'),
...
<section class="bg-gray-900 py-20 sm:py-32 relative" id="pricing">
    <div class="container">
        ...
        <div class="pricing-table mt-10">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                @foreach ($plans as $plan)
                    <div class="pricing-card flex flex-col justify-between p-[30px] rounded-[20px] text-white relative hover:shadow-2xl hover:scale-[1.035] transition-all duration-500 {{ $plan['isMostChosen'] ? 'border-3 border-[#FF8D28]' : ''}}"
                        style="background-color: {{ $plan['singleColor'] }}"
                        data-plan='@json($plan['packages'])'
                        data-single-color="{{ $plan['singleColor'] }}"
                        data-monthly-color="{{ $plan['monthlyColor'] }}"
                        data-most-chosen="{{ $plan['isMostChosen'] ? 'true' : 'false'}}">

                        @if($plan['isMostChosen'])
                        <div class="most-chosen-badge absolute -top-3 left-1/2 -translate-x-1/2 bg-[#FF8D28] text-white text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wide">
                            {{ __('Most Chosen') }}
                        </div>
                        @endif
                        ...
                        <div class="flex flex-col gap-4 pb-6 border-b" style="border-color: {{ $plan['borderColor'] }}">
                            ...
                            <div class="flex items-baseline gap-1 flex-col">
                                <span class="price text-[36px] font-extrabold"></span>
                                <span class="plan-frequency text-sm lg:text-lg font-medium leading-3"></span>
                            </div>
                        </div>
        ...
        <div class="extra-options border-4 border-[#fff] rounded-[20px] mt-6 p-[20px] md:p-[30px]">
