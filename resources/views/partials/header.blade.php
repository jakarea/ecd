    ...
    <div class="container mx-auto">
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="hidden md:block">
                <a href="{{ route('services-subscriptions', ['locale' => app()->getLocale()]) }}" class="btn-brand-sm"><span>{{ __('Let\'s Talk') }}</span>
...
<div class="modal px-5" id="heroModal">
    ...
    <div
        ...
        <form id="bookingForm" method="POST" action="{{  route('booking.store', ['locale' => app()->getLocale()]) }}"
            ...
            <div class="grid grid-rows-[auto_1fr_auto] h-full space-y-6 pr-5 md:pr-[30px]">
                <!-- Header -->
                ...
                <div class="flex justify-end mt-6">
                    <button type="submit" id="bookNowBtn"
                        class="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 text-base font-medium text-white bg-[var(--color-brand)] rounded-lg shadow-md hover:bg-[var(--color-brand)] transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 cursor-pointer">
        ...
        fetch(form.action, {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // console.log("Response after form submission", data.message);
                    modal.classList.remove('show');
                    Swal.fire({
                        icon: 'success',
                        title: 'Success!',
