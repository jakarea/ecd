            ...
            <div class="overflow-x-auto">
                <div class="table w-full min-w-[980px]">
                    <div class="table-header-group">
                        <div class="tr flex">
                            <div class="td w-1/4 py-5 flex flex-col justify-center h-[206px]">
                                <h3
                                    class="text-black font-medium text-[20px] whitespace-nowrap flex items-center gap-3">
                            ...
                            <div class="td w-1/4 p-5 bg-[#003868] rounded-tl-[16px]">
                                <div class="pricing-card-header flex flex-col gap-4">
                                    <div
                                        class="w-[35px] h-[35px] bg-white rounded-[13px] flex justify-center items-center">
                                    ...
                                    <h3 class="text-[22px] font-medium text-white">Regular Subscription</h3>
                                    <span class="text-[36px] font-extrabold text-white">€79.95</span>
                                </div>
                            </div>
                            <div class="td w-1/4 p-5 bg-[var(--color-brand)]">
                                <div class="pricing-card-header flex flex-col gap-4">
                                    <div
                                        class="w-[35px] h-[35px] bg-white rounded-[13px] flex justify-center items-center">
                                    ...
                                    <h3 class="text-[22px] font-medium text-white">Premium Subscription</h3>
                                    <span class="text-[36px] font-extrabold text-white">€149.95</span>
                                </div>
                            </div>
                            <div class="td w-1/4 p-5 bg-[#CBA328]">
                                <div class="pricing-card-header flex flex-col gap-4">
                                    <div
                                        class="w-[35px] h-[35px] bg-white rounded-[13px] flex justify-center items-center">
                                    ...
                                    <h3 class="text-[22px] font-medium text-white">Premium Subscription</h3>
                                    <span class="text-[36px] font-extrabold text-white">€289.95</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tbody">
                        <div class="tr flex border border-[#CBD6E9] rounded-tl-[16px]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Discount</span>
                            </div>
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center">
                            ...
                            <div class="td w-1/4 py-5 px-[30px] text-center bg-[#CBA32810]">
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Service</span>
                            </div>
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center">
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9] bg-[#F6F9FF]">
                            <div class="td w-1/4 py-2 px-[30px] border-r border-[#CBD6E9]">
                                <span
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Vacuuming</span>
                            </div>
                            <div
                                class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center flex justify-center items-center">
                            ...
                            <div
                                class="td w-1/4 py-5 px-[30px] text-center flex justify-center items-center bg-[#CBA32810]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">
                                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <ellipse cx="12.667" cy="12.4999" rx="12" ry="12.0001" fill="#34C759" />
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Cleaning windows
                                    (inside)</span>
                            </div>
                            <div
                                class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center flex justify-center items-center">
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Cleaning compartments and
                                    trays</span>
                            </div>
                            <div
                                class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center flex justify-center items-center">
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Dashboard cleaning</span>
                            </div>
                            <div
                                class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center flex justify-center items-center">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Plastic parts cleaning</span>
                            </div>
                            <div
                                class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center flex justify-center items-center">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Carpet mats cleaning</span>
                            </div>
                            <div
                                class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center flex justify-center items-center">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Steering wheel
                                    cleaning</span>
                            </div>
                            <div
                                class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center flex justify-center items-center">
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9] bg-[#F6F9FF]">
                            <div class="td w-1/4 py-2 px-[30px] border-r border-[#CBD6E9]">
                                <span
                                    class="text-[18px] font-bold text-[var(--color-text)] font-sf uppercase">Exterior</span>
                            </div>
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center">
                                <span class="text-[16px] text-[var(--color-text)] font-sf"></span>
                            </div>
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Thorough wash including rims,
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Removes dirt, deposits, and
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9] bg-[#F6F9FF]">
                            <div class="td w-1/4 py-2 px-[30px] border-r border-[#CBD6E9]">
                                <span
                                    class="text-[18px] font-bold text-[var(--color-text)] font-sf uppercase">Extra</span>
                            </div>
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center">
                                <span class="text-[16px] text-[var(--color-text)] font-sf"></span>
                            </div>
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Perfume of choice</span>
                            </div>
                            <div
                                class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center flex justify-center items-center">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">
                        ...
                        <div class="tr flex border-l border-r border-b border-[#CBD6E9]">
                            <div class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9]">
                                <span class="text-[16px] text-[var(--color-text)] font-sf">Choice of one extra
                                    option</span>
                            </div>
                            <div
                                class="td w-1/4 py-5 px-[30px] border-r border-[#CBD6E9] text-center flex justify-center items-center">
